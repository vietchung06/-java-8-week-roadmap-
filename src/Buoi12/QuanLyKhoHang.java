            ...
            try {
                ...
                switch (chon) {
                    ...
                    case 1 -> {
                        ...
                        System.out.print("Nhập SKU muốn thêm: ");
                        ...
                        if (kho.containsKey(sku)) {
                            ...
                            kho.put(
                                    sku,
                                    new Products(sku, name, price, quantity)
                            );
                    ...
                    case 2 -> {
                        ...
                        if (products == null) {
                            throw new RuntimeException(
                                    "Không tìm thấy sản phẩm có SKU: " + sku
                            );
                        }

                        System.out.print("Nhập số lượng muốn xuất: ");
                        int quantity = sc.nextInt();
                ...
                System.out.println("Lỗi: Bạn phải nhập đúng kiểu số");
                sc.nextLine();
